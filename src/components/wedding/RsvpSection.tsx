...
const rawGuests = [
  ...
  "ALEXSÂNIA FABIANA", "ANA DALAGLIO", "ANA CAROLINA COSTA", "ANA BEATRIZ LOPES",
  ...
  "APARECIDA ELAINE", "BIANCA GERVASIO", "ANNA CAROLINE FARIA",
  ...
  "LUDIMILA SOUZA", "LUIZ LIMA", "MARCELO DALAGLIO",
